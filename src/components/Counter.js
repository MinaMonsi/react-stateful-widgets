...
import React, {useState} from 'react'; /* STEP 0 - Imported state hook */

export default function Counter() {
  /* STEP 1 - Created count state */
  ...
  const style = {
    fontSize: '1.5em',
    marginBottom: '0.3em',
    color: count % 2===0 ? 'royalblue' : 'crimson', /* STEP 2 - Ternary expression written */
  };
